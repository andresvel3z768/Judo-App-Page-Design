...
export const techniques: Technique[] = [
  ...
  { id: 't1', name: 'Uki-Goshi', translation: 'Cadera Flotante', category: 'NAGE-WAZA', belt: 'Amarillo', videoUrl: 'https://youtu.be/bPKwtB4lyOQ?si=sNbIo2IB8PTlLoZB', description: 'Se toma el kumi-kata tradicional, agarrando la solapa y manga del oponente. Se gira el cuerpo metiendo la cadera por debajo del centro de gravedad del adversario, mientras se mantiene el brazo alrededor de su cintura. Se jala con ambas manos hacia arriba y adelante, usando la cadera como punto de apoyo para levantarlo y proyectarlo sobre el hombro.' },
  { id: 't2', name: 'O-Goshi', translation: 'Gran Cadera', category: 'NAGE-WAZA', belt: 'Amarillo', videoUrl: 'https://youtu.be/yhu1mfy2vJ4?si=PaKdP0KyaOoFC8he', description: 'Se agarra la solapa y manga del oponente con el kumi-kata. Se da un paso profundo con el pie derecho delante del oponente, girando el cuerpo y colocando la cadera justo debajo de la suya. Se pasa el brazo derecho alrededor de su cintura, abrazándolo fuertemente. Se flexionan las piernas y se proyecta jalando con los brazos mientras se extienden las piernas, usando la cadera como palanca.' },
  { id: 't3', name: 'Ippon-Seoi-Nage', translation: 'Lanzamiento por Encima del Hombro con Un Brazo', category: 'NAGE-WAZA', belt: 'Amarillo', videoUrl: 'https://youtu.be/FQnOlCxo4oI?si=b2pn7mDnqLqr3Ad6', description: 'Se toma el kumi-kata estándar. Se gira el cuerpo metiendo el brazo derecho por debajo del brazo del oponente, colocando el hombro en su axila. Se da un paso cruzado con el pie derecho delante de él, seguido del pie izquierdo. Se flexionan las rodillas bajando el centro de gravedad, se jala con el brazo izquierdo mientras se levanta con el hombro derecho para proyectarlo por encima.' },
  { id: 't4', name: 'De-ashi-harai', translation: 'Barrido del Pie Adelantado', category: 'NAGE-WAZA', belt: 'Amarillo', videoUrl: 'https://youtu.be/4BUUvqxi_Kk?si=HUooASA7tUUzM-gN', description: 'Se toma el kumi-kata en solapa y manga. Se espera el momento en que el oponente adelanta el pie derecho para dar un paso. Justo cuando su pie toca el suelo pero antes de que cargue el peso, se barre con la planta del pie en dirección del movimiento del oponente. Simultáneamente se jala con las manos hacia arriba y en la dirección del barrido para desequilibrarlo y proyectarlo.' },
  { id: 't5', name: 'O-uchi-gari', translation: 'Gran Cadera Interior', category: 'NAGE-WAZA', belt: 'Amarillo', videoUrl: 'https://youtu.be/4BUUvqxi_Kk?si=HUooASA7tUUzM-gN', description: 'Se toma el kumi-kata en solapa y manga. Se espera el momento en que el oponente adelanta el pie derecho para dar un paso. Justo cuando su pie toca el suelo pero antes de que cargue el peso, se barre con la planta del pie en dirección del movimiento del oponente. Simultáneamente se jala con las manos hacia arriba y en la dirección del barrido para desequilibrarlo y proyectarlo.' },
  // Cinturón Amarillo - KATAME-WAZA
  { id: 'n1', name: 'Hon Kesa Gatame', translation: 'Control en Bandolera', category: 'KATAME-WAZA', belt: 'Amarillo', videoUrl: 'https://youtu.be/NDaQuJOFBYk?si=qI--9F-TL2zsA9P0', description: 'Con el oponente en el suelo boca arriba, se posiciona el cuerpo perpendicular al suyo, sentándose junto a su costado derecho. Se pasa el brazo derecho por debajo de su cuello, agarrando el cinturón o gi en la espalda. El brazo izquierdo controla su brazo derecho, manteniéndolo cerca del cuerpo. Las piernas se extienden con la derecha flexionada para mayor estabilidad, manteniendo el peso sobre el pecho del oponente.' },
  
  
  // Cinturón Amarillo - NAGE-WAZA
  { id: 't4', name: 'De Ashi Barai', translation: 'Barrido del Pie Adelantado', category: 'NAGE-WAZA', belt: 'Amarillo', videoUrl: 'https://www.youtube.com/embed/gqY7O3qVbJw', description: 'Se toma el kumi-kata en solapa y manga. Se espera el momento en que el oponente adelanta el pie derecho para dar un paso. Justo cuando su pie toca el suelo pero antes de que cargue el peso, se barre con la planta del pie en dirección del movimiento del oponente. Simultáneamente se jala con las manos hacia arriba y en la dirección del barrido para desequilibrarlo y proyectarlo.' },
  { id: 't5', name: 'Hiza Guruma', translation: 'Rueda de Rodilla', category: 'NAGE-WAZA', belt: 'Amarillo', videoUrl: 'https://www.youtube.com/embed/7yVLYKVTxHs', description: 'Con el kumi-kata establecido, se jala al oponente hacia adelante y ligeramente hacia la derecha para desequilibrarlo. Se coloca la planta del pie derecho contra su rodilla derecha, actuando como bloqueo. Se continúa jalando con fuerza con ambas manos hacia arriba y en círculo, usando el pie como punto de apoyo. El oponente gira sobre su rodilla bloqueada y cae.' },
  { id: 't6', name: 'Sasae Tsurikomi Ashi', translation: 'Pie que Sostiene y Levanta', category: 'NAGE-WAZA', belt: 'Amarillo', videoUrl: 'https://www.youtube.com/embed/3yKZNx8KYiI', description: 'Se agarra la solapa y manga del oponente. Se le hace avanzar o se espera su movimiento adelante. Se bloquea su pie adelantado colocando la planta del propio pie contra su tobillo o pantorrilla. Al mismo tiempo se jala fuertemente con ambas manos hacia arriba y atrás, levantándolo mientras el pie bloquea su avance, causando la caída hacia atrás.' },
